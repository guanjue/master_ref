def dist_sort(bed1,bed2,cdt1,cdt2):
	...
	dist1=dist_sort
	data11=open(cdt1+'.cdt','r')
	cdt_1={}
	cdt_1_sort=open(cdt1+'.distsort.cdt','w')
	...
	dist2=dist_sort
	data21=open(cdt2+'.cdt','r')
	cdt_2={}
	cdt_2_sort=open(cdt2+'.distsort.cdt','w')
