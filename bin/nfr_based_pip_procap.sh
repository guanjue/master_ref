...
cd /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_refs/

#cat Xu_2009_ORF-Ts_V64_sort.noexpan.bed | awk -F '\t' -v OFS='\t' '{if ($6=="+") print $1,$2-500,$2+501,$4,$5,$6; else print $1,$3-500,$3+501,$4,$5,$6}' > Xu_2009_ORF-Ts_V64_sort_TSS1k.bed
#java -jar /Users/universe/Documents/bin/cegr-tools/build/dist/TagPileup.jar -b /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031844_1.qt.adpt.36.fastq.mapped.sort.bam -i /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031844_1.qt.adpt.36.fastq.mapped.sort.bam.bai -c Xu_2009_ORF-Ts_V64_sort_TSS1k.bed -s 0 -n 1 -e false -r 0 -p false -a 1 -t 3 -w 0 -h true -m false
#java -jar /Users/universe/Documents/bin/cegr-tools/build/dist/TagPileup.jar -b /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031845_1.qt.adpt.36.fastq.mapped.sort.bam -i /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031845_1.qt.adpt.36.fastq.mapped.sort.bam.bai -c Xu_2009_ORF-Ts_V64_sort_TSS1k.bed -s 0 -n 1 -e false -r 0 -p false -a 1 -t 3 -w 0 -h true -m false

#python /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/master_ref/bin/subtract_bg.py -s Xu_2009_ORF-Ts_V64_sort_TSS1k_SRR3031844_1_read1_combined.tabular -b Xu_2009_ORF-Ts_V64_sort_TSS1k_SRR3031845_1_read1_combined.tabular -o Xu_2009_ORF-Ts_V64_sort_TSS1k_SRR3031844_SRR3031845_1_read1_combined.tabular

#python /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/master_ref/bin/relocate_TSS.py -b Xu_2009_ORF-Ts_V64_sort_TSS1k.bed -r Xu_2009_ORF-Ts_V64_sort_TSS1k_SRR3031844_SRR3031845_1_read1_combined.tabular -o Xu_2009_ORF-Ts_V64_sort_TSS2001_procap.bed -t 50 -w 1000

#java -jar /Users/universe/Documents/bin/cegr-tools/build/dist/TagPileup.jar -b /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031844_1.qt.adpt.36.fastq.mapped.sort.bam -i /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/procap_proseq_bam/SRR3031844_1.qt.adpt.36.fastq.mapped.sort.bam.bai -c Xu_2009_ORF-Ts_V64_sort_TSS2001_procap.bed.2000.bed -s 0 -n 1 -e false -r 0 -p false -a 0 -t 3 -w 0 -h true -m false




#python /Volumes/MAC_Data/data/labs/pugh_lab/master_ref/master_ref/bin/get_NFR.py -f Xu_2009_ORF-Ts_V64_sort_TSS2001_procap_h3_merged_MN_seq_sort_read1_combined.cdt -w 100 -s 25 -l 79 -u 1000 -d 0

paste Xu_2009_ORF-Ts_V64_sort_TSS2001_procap.bed.2000.bed Xu_2009_ORF-Ts_V64_sort_TSS2001_procap_h3_merged_MN_seq_sort_read1_combined.cdt.nucleosome.txt > Xu_2009_ORF-Ts_V64_sort_h3_merged_MN_seq_sort_read1_combined.cdt.nucleosome.txttmp
