...
#print(quantile(data,thresh)[1])
my_palette <- colorRampPalette(c("white", args[3]))(n = 19)
if (thresh >0){
		colors = seq(0,thresh,length=20)
	} else{
...
png(paste(args[2],'png',sep='.'),width=1001,height=1200)
